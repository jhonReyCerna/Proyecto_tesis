...
<head>
    ...
    <link rel="stylesheet"
        href="@yield('puntos')db/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="@yield('puntos')db/dist/img/AdminLTELogo.png" alt="AdminLTELogo"
                height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="@yield('puntos')db/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        @if (file_exists('users/' . auth()->user()->id . '.jpg'))
                            <img src="@yield('puntos')users/{{ auth()->user()->id }}.jpg" alt=""
                                height="250" width="250" class="img-circle elevation-2">
                        @else
                            <img src="@yield('puntos')users/default.jpg" alt="" height="250" width="250"
                            ...
                            <ol class="breadcrumb float-sm-right">
                                ...
                                @if (isset($artista) && isset($album))
                                    <li class="breadcrumb-item active"><a
                                            href="{{ route('reporte', [$artista, $album]) }}"
                                            style="text-decoration: none; color: gray;" target="_blank">Report</a>
                                    </li>
                                @else
                                    @if (isset($artista))
                                        <li class="breadcrumb-item active"><a
                                                href="{{ route('reporte', [$artista, 0]) }}"
                                                style="text-decoration: none; color: gray;" target="_blank">Report</a>
                                        </li>
                                    @else
                                        <li class="breadcrumb-item active"><a href="{{-- {{route('reporte', [0, 0])}} --}}"
                                                style="text-decoration: none; color: gray;" target="_blank">Report</a>
                                        </li>
                                    @endif
                                @endif
